...
class KenKenGenerator(Scene):
    ...
    def construct(self):
        # Hardcoded cage data based on your descriptor file
        size = 4
        cages = [
        ...
        print(f"Loaded {len(cages)} cages for {size}x{size} puzzle")
        ...
        for cage_idx, cage in enumerate(cages):
            ...
            hint_text.move_to([anchor_x + cell_size/2 - 0.15, anchor_y - cell_size/2 + 0.15, 0])
